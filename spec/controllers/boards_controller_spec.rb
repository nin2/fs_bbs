  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved board as @board" do
        ...
        post :create, {:board => { "country" => "invalid value" }}, valid_session
        assigns(:board).should be_a_new(Board)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested board" do
        ...
        Board.any_instance.should_receive(:update_attributes).with({ "country" => "" })
        put :update, {:id => board.to_param, :board => { "country" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the board as @board" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Board.any_instance.stub(:save).and_return(false)
        put :update, {:id => board.to_param, :board => { "country" => "invalid value" }}, valid_session
        assigns(:board).should eq(board)
      end
