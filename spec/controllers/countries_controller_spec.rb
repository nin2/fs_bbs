  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved country as @country" do
        ...
        post :create, {:country => { "country_area" => "invalid value" }}, valid_session
        assigns(:country).should be_a_new(Country)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested country" do
        ...
        Country.any_instance.should_receive(:update_attributes).with({ "country_area" => "" })
        put :update, {:id => country.to_param, :country => { "country_area" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the country as @country" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Country.any_instance.stub(:save).and_return(false)
        put :update, {:id => country.to_param, :country => { "country_area" => "invalid value" }}, valid_session
        assigns(:country).should eq(country)
      end
